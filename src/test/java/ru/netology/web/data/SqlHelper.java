...
public class SqlHelper {
    ...
    public static String getCreditId(){
        var creditIdSQL = "SELECT credit_id FROM order_entity WHERE created > NOW() -INTERVAL 1 MINUTE;";
    ...
    public static String getPaymentId(){
        var creditIdSQL = "SELECT payment_id FROM order_entity WHERE created > NOW() -INTERVAL 1 MINUTE;";
        var runner = new QueryRunner();
        var conn = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/app", "app", "pass");
    ...
    public static String getCreditBankId(){
        var creditBankIdSQL = "SELECT bank_id FROM credit_request_entity WHERE created > NOW() -INTERVAL 1 MINUTE;";
        var runner = new QueryRunner();
        var conn = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/app", "app", "pass");
    ...
    public static String getTransactionId(){
        var transactionIdSQL = "SELECT transaction_id FROM payment_entity WHERE created > NOW() -INTERVAL 1 MINUTE;";
        var runner = new QueryRunner();
        var conn = DriverManager.getConnection(
                "jdbc:mysql://localhost:3306/app", "app", "pass");
